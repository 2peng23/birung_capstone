							...
							<!-- Section -->
								<section>
									...
									<div class="features">
											...
											<form action="{{url('save-patient')}}" method="post" style=" width:100%;">
												@csrf
													...
													<div class="record-box1">
														  <div class="basics">
															...
															<label>Name:</label>
															<input type="text" name="name" required autocomplete="off" autofocus><br>
														
															<label>Email:</label>
															<input type="email" name="email"  autocomplete="off"><br>
								
															<label>Age:</label>
															<input type="number" name="age" required autocomplete="off"><br>
															  
															<label style="color:black;">Sex:</label>
															  <select name="sex" required style="color:black;">
															...
															<input type="date" name="bday"  autocomplete="off"><br>
								
															<label>Contact Number:</label>
															<input type="number" pattern="[0-9]{11}" name="phone"  autocomplete="off"><br>
														  </div>
								
														  <div class="stats">
															<label>Stats</label> <hr style="color:black;"><hr style="color:black;">
															<label>Height:</label>
															<input type="number" name="height" placeholder="cm"  autocomplete="off"><br>
								
															<label>Weight:</label>
															<input type="number" name="weight" placeholder="kg"  autocomplete="off"><br>
								
															<label>BMI:</label>
															<input type="text" name="bmi"  autocomplete="off"><br>
								
															<label>BP:</label>
															<input type="text" name="bp"  autocomplete="off"><br>
															
															<label>O2 Sat:</label>
															<input type="text" name="o2sat"  autocomplete="off"><br>
															
															<label>HR:</label>
															<input type="text" name="hr"  autocomplete="off"><br>
															
															<label>Temperature:</label>
															<input type="text" name="temp"  autocomplete="off"><br>
														  </div>
													 </div>
												  <div class="record-box2">
													 <div class="notes1">
															<label>Diagnosis:</label>
															<textarea name="diag" id="" cols="5" rows="1" autocomplete="off" style="color:black;height:100px"></textarea>
								
															<label>Prescriptions:</label>
															<textarea name="prec" id="" cols="30" rows="10" autocomplete="off" style="color:black;height:100px"></textarea>
													 </div>
													 
													 <div class="notes2">
															<label>Notes:</label>
															<textarea name="notes" id="" cols="30" rows="10" autocomplete="off" style="color:black;height:100px"></textarea>
													 </div>
												  </div>
															<div style="margin:20px 20px;">
																
																<input  type="submit"  style=" color:black; height:44px"> 
																<button style="width: 100px; height:45px;border-radius:10px;"><a href="{{url('intpatient-list')}}">Back</a></button>
