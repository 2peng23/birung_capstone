								...
								<section  style="position: relative;">
									...
									<div class="features">
                                        ...
                                        <h2>Patient Information</h2>
                                            <div class="info">
                                                <div class="basics">
                                                    <p>Name: {{$data2->name2}}</p>
                                                    <p>Email: {{$data2->email2}}</p>
                                                    <p>Age: {{$data2->age2}}</p>
                                                    <p>Sex: {{$data2->sex2}}</p>
                                                    <p>Address: {{$data2->address2}}</p>
                                                    <p>Birthday: {{$data2->bday2}}</p>
                                                    <p>Contact Number: {{$data2->phone2}}</p>
                                                </div>
                                                <div class="stats">
                                                    <p>Height: {{$data2->height2}}</p>
                                                    <p>Weight: {{$data2->weight2}}</p>
                                                    <p>BMI: {{$data2->bmi2}}</p>
                                                    <p>BP: {{$data2->bp2}}</p>
                                                    <p>O2 Sat: {{$data2->o2sat2}}</p>
                                                    <p>HR: {{$data2->hr2}}</p>
                                                    <p>Temperature: {{$data2->temp2}}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card">
                                        <h2>Medical Information</h2>
                                        <p>Diagnosis: {{$data2->diag2}}</p>
                                        <p>Prescription: {{$data2->prec2}}</p>
                                        <p class="section" id="print">Notes: {{$data2->notes2}}</p>
                                        </div>
                                    </div>
                                    
                                    <div class="cert">
                                        <a href="{{url('generateobcert', $data2->id)}}" class="btn btn-success" style="color: black;">Generate Medical Certificate</a>
                                    </div>
