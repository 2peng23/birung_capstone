									...
									<div class="features">
										<div style="align:center;" >
                                            ...
                                            <div style=" width:98%; margin:10px auto;display:flex;justify-content:space-between;">
                                              <div>
                                                <form action="{{url('search-ob-record-archive')}}" method="post" style="color: black;  margin-top:10px;">
                                                  {{csrf_field()}}
                                                ...
                                                <form method="GET" action="{{ url('/archive-obpatient') }}">
                                        ...
                                        <a href="{{url('obpatient-list')}}" class="btn btn-primary">Back</a>
