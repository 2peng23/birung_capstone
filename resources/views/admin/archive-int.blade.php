					...
					<div id="main">
						<div class="inner">
							...
							<!-- Section -->
								<section>
									<header class="major">
										<h2>Inactive Internal Medicine Patient</h2>
									</header>
									<div class="features">
										<div style="align:center;" >
                                            ...
                                            <div style=" width:98%; margin:10px auto;display:flex;justify-content:space-between;">
                                                    <div>
                                                      <form action="{{url('search-record-archive')}}" method="post" style="color: black;  margin-top:10px;">
                                                        {{csrf_field()}}
                                                        <input type="search" required name="nname" autocomplete="" style="border-color:black;width:200px" placeholder="Input Patient's Name...">
                                                        <button type="submit" style="color:black;height:43px;width:150px;margin-top:10px;" hidden>Search Patient</button>
                                                      </form>
                                                      <form method="GET" action="{{ url('/archive-patient') }}">
                                            ...
                                            <div  id="printable">
                                              ...
                                              @foreach($sortedData as $patientdata2)
                                                  <tr style="color: black; border:1px solid black;">
                                                      ...
                                                      <td>{{$patientdata2 ->email}} <br> {{$patientdata2->phone}}</td>
                                          ...
                                          <a href="{{url('intpatient-list')}}" class="btn btn-primary">Back</a>
