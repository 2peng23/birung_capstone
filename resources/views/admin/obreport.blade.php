        ...
        <div class="main-panel">
          ...
          <div style="align:center; width:98%; margin:0 auto;position:relative;" class="container" id="print">
            ...
            <div style="width:100%;margin:20px auto;text-align:center;">
                <h1 style="color:black;font-size:40px;font-style:bolder;text-transform:uppercase;">Weekly Ob-Gyne Patient's Report</h1>
            </div>
          ...
          <div  class="table-responsive">
            <table class="table" style="border:solid black 1px;margin:0 auto;width:100%;" >
                ...
                @php
                    $x = ($data2->currentPage()-1) * $data2->perPage() + 1;
                @endphp
                @foreach($data2 as $patientdata2)
                <tr style="color: black;text-align:center;">
                    <td>{{$x++}}</td>
